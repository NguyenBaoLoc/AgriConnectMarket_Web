      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover premium organic farms committed to sustainable agriculture
            and delivering the freshest produce directly to your doorstep
          </p>
        </div>

        {/* Farms Grid */}
        <div
          className="mt-8 mb-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6"
          style={{
            marginBottom: '64px',
          }}
        >
