  ...
  return (
    <Card className='overflow-hidden hover:shadow-lg transition-shadow'>
      ...
      <div className='relative'>
        ...
        />
        {batch.harvestDate === null || batch.harvestDate === undefined ? (<div className='absolute inset-0 bg-black/40 flex items-center justify-center' style={{
          ...
          <div className='absolute inset-0 bg-black/40 flex items-center justify-center' style={{
            backgroundColor: "#efefef",
            opacity: 0.8
          }}>
            <span className='text-white font-semibold' style={{
